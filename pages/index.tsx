        ...
        >
          ...
          >
            ...
            <Text fontFamily='Inter'>
              The only player-owned role-playing game in the world. Great Wyrm players have full control of the world we all play in.
            </Text>
          ...
          >
            ...
            <Flex direction='column' gap='20px' textAlign={['center', 'center', 'start']} flex='1'>
              <Text fontWeight='700' fontSize={{ base: '30px', l: '40px' }} lineHeight='120%'>
                Act I: An Awakening in Kalash
              </Text>
              <Text fontFamily='Inter'>
                At the heart of the caves, a hidden treasure awaits, and it is not at all what you expected. The choice you make today will
                change your life and life in the Kingdom of Reda forever.
              </Text>
              <Flex h='100%' alignItems='center'>
                <Text fontFamily='Inter' fontWeight='700'>
                  Want to choose the fate of these adventurers?
                </Text>
              </Flex>
              <Button
                variant='wyrmButton'
          ...
          >
            ...
            <Flex direction='column' gap='20px' textAlign={['center', 'center', 'start']} flex='1' flexShrink='1'>
              ...
              <Text fontFamily='Inter'>
                Create your own stories behind the paths you choose. Form alliances based on your choices. Convince other people to join
                your alliance, or trick them into choosing paths that end in despair.
              </Text>
              <Spacer />
              <Button
                variant='wyrmButton'
          ...
          >
            ...
            <Flex direction='column' gap='20px' textAlign={['center', 'center', 'start']} flex='1'>
              ...
              <Text fontFamily='Inter'>
                If creating elaborate adventures for players to embark on is more your thing, become a Game Master.
              </Text>
              <Text fontFamily='Inter'>
                Create new stories. Bring the content you&apos;ve already developed but haven&apos;t had a chance to play through. See
                ratings of how many people played your sessions.
              </Text>
          ...
          >
            ...
            <Flex direction='column' gap='20px' textAlign={['center', 'center', 'start']} flex='1'>
              ...
              <Text fontFamily='Inter'>
                Great Wyrm runs on the Garden of Forking Paths, a platform which allows anybody to host and run multiplayer choose your own
                adventure games..
              </Text>
              <Text fontFamily='Inter'>
          ...
          <Flex direction='column' gap={{ base: '20px', sm: '30px' }} pt={{ base: '40px', sm: '80px' }} pb={{ base: '40px', sm: '80px' }}>
            <Flex
              ...
              px={['20px', '20px', '40px', '120px', '182px']}
              gap='30px'
              borderRadius='30px'
              border='1px solid white'
              textAlign='center'
            >
              <Text fontWeight='700' fontSize={{ base: '24px', sm: '30px', l: '40px' }} lineHeight='120%'>
                True Open Gaming License
              </Text>
              <Text fontFamily='Inter'>
                We value and support content creators. No corporate overlords collect taxes here. All the fees go to content creators, and
                to support the infrastructure behind the game.
              </Text>
              {/* </Flex> */}
              <Flex
                textAlign='center'
