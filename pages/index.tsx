...
const assets = {
  ...
  roadmapL: `${AWS_ASSETS_PATH}/roadmap_large.jpeg`,
  roadmapSm: `${AWS_ASSETS_PATH}/roadmap_small.jpeg`,
}
    ...
    <Layout home={true}>
      ...
      <Flex
        ...
        backgroundImage={`${gradient}, url(${
          isVerySmallView ? assets.coverSm : is1440View ? assets.coverMd : assets.coverLg
        })`}
      >
        <Image
          src={assets.logo}
        ...
        >
          ...
          >
            ...
            <Text fontFamily='Inter'>
              A fully on-chain fantasy text-based RPG where {isBaseView ? '' : <br />}you create history and lore with
              your actions.
            </Text>
            <Flex mt='20px' w={['100%']} direction={['column']} gap='10px' justifyContent='center' alignItems='center'>
              <Link
                minW={{ base: '100%', sm: '0' }}
                href='https://guide.greatwyrm.xyz/beginners-rulebook/first-time-setup'
                target='_blank'
              >
                <Button
                  variant='wyrmButton'
          ...
          <Text variant='paragraph'>
            Great Wyrm is a fully on-chain fantasy RPG teeming with dwarves, elves, and dragons. The story begins in the
            Kingdom of Reda, where political tension erupts into chaos as the discovery of a dragon egg–wait, dragons
            are real??–brings magic to a bleak and non-magical world.
            <br />
            <br />
            In Great Wyrm’s first act, players explore Reda and its neighboring lands, battle ravenous beasts, and forge
            alliances with monarchs, usurpers, rebels, and guilds. As they play, they  accrue in-world assets, such as
            experience, influence, items, and favor, that allow them to develop their characters and increase their
            riches.
          </Text>
          ...
          <Image
            w={{ base: '300px', md: '366px', l: '600px' }}
            mt={{ base: '50px', sm: '130px' }}
            src={assets.pastStages}
            alt=''
          />
          <Text variant='title'>The story so far...</Text>
          <Text variant='paragraph'>
            In the first-ever Great Wyrm adventure, “The Discovery,” a small band of treasure hunters braved the
            darkness of Kalash’s copper mines and found something that will change their world forever: a dragon egg,
            left slumbering in the shadows for centuries.
            <br />
            <br />
            There has never been magic in the muddy alleys of Kalash before.
            <br />
            <br />
            Whether this wyrmling means hope or destruction for the Kingdom of Reda, right now its fate is in the hands
            of a few unlikely heroes–and in yours!
          </Text>
          <Link
          ...
          >
            <Image
              alt=''
              src={is1440View ? assets.card1Sm : assets.card1L}
              h={{ base: '346px', sm: '390px' }}
              minW='260px'
              mx='auto'
            />
          </Box>
          <Text variant='title'>Start your adventure</Text>
          <Text variant='paragraph' my={{ base: '30px', sm: '40px' }} align='center' fontWeight='700'>
          ...
          <Flex gap='20px' direction='column' textAlign='center' maxW='320px'>
            {tutorial.map((step, idx) => (
              <Flex direction='column' gap='10px' key={idx} alignItems='center'>
                ...
                {idx !== 1 ? (
                  <Text variant='paragraph' mt='0' textAlign='center'>
                    {step}
                  </Text>
                ) : (
                  <Text variant='paragraph' mt='0' textAlign='center'>
                    Join our Discord. Introduce your character or request{' '}
                    <Link
                      href='https://guide.greatwyrm.xyz/the-lore/characters/unclaimed-characters-from-the-discovery'
                      target='_blank'
                    >
                      a premade one
                    </Link>
                    . We’ll give you a character token.
                  </Text>
                )}
              </Flex>
            ))}
          ...
          >
            <Image
              alt=''
              src={is1440View ? assets.card2Sm : assets.card2L}
              h={{ base: '346px', sm: '390px' }}
              minW='260px'
              mx='auto'
            />
          ...
          <Text variant='paragraph'>
            ...
            <br />
            <br />
            Great Wyrm is a highly political game. You can enjoy influencing the game’s world by both adventuring and
            making political decisions. <br />
            <br />
            The main action is set in the Kingdom of Reda. It’s ruled over by Queen Seraphima, who has just come of age.
            Until her majority, the kingdom was ruled by her regent and uncle, Duke Forobor. You can chose to support
            either one of them.
            <br />
            <br />
            Currently, plotlines are unfolding in two places within the kingdom: the capital city of Heelis, and the
            mining town of Kalash.
          </Text>
          ...
          <Flex mt={{ base: '80px', sm: '160px' }} direction='column' gap={{ base: '40px', sm: '60px' }}>
            <Text variant='title'>Roadmap</Text>
            <Box borderRadius='15px' border='1px solid #FCE5DD' w='100%'>
              <Image
                borderRadius='15px'
                alt=''
                src={isBaseView ? assets.roadmapSm : assets.roadmapL}
                h={{ base: '438px', sm: '493px' }}
                minW='260px'
                mx='auto'
              />
            </Box>
          ...
          >
            <Image
              alt=''
              src={is1440View ? assets.card3Sm : assets.card3L}
              h={{ base: '346px', sm: '390px' }}
              minW='270px'
              mx='auto'
            />
          ...
          <Text variant='paragraph'>
            <b>Long sessions</b> are longer RPG campaigns. The stories tie into the ongoing plotline of Great Wyrm. An
            example of a finished full-length session:&nbsp;
            <Link
              href='https://greatwyrm.xyz/voting/?contractAddress=0x42A8E82253CD19EF8274D48fC0bC89cdf1B4425b&sessionId=1'
              target='_blank'
            >
              The Discovery
            </Link>
            <br />
            <br />
            <b>Short sessions</b> are games built around a single decision. Examples of this are the{' '}
            <Link href='https://guide.greatwyrm.xyz/players-handbook/types-of-games/the-reda-games' target='_blank'>
              Reda Games
            </Link>
            , the Garden of Forking Paths, upcoming boss fights, and other game modes that are currently in the works.
            We often use them to test new mechanics and types of gameplay.
            <br />
            <br />
          ...
          >
            <Text fontFamily='Inter' textAlign={['center']}>
              The game is now in early access. You can start creating your own content, making your own characters,
              forming alliances, or apply to be a Game Master.{' '}
            </Text>
          </Flex>
          <Flex
            textAlign='center'
