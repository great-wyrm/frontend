...
export interface MockERC721 extends BaseContract {
  constructor(jsonInterface: any[], address?: string, options?: ContractOptions): MockERC721
  clone(): MockERC721
  methods: {
    ...
    mint(to: string, tokenId: number | string | BN): NonPayableTransactionObject<void>
